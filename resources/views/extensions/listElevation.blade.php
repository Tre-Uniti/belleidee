...
@section('centerText')
    <h2>Elevations of  <a href={{ url('/extensions/'. $extension->id)}}>this Extension</a></h2>
    <div class = "indexNav">
        <a href={{ url('/extensions/' . $extension->id) }}><button type = "button" class = "indexButton">Show Extension</button></a>
