...
@foreach ($posts as $post)
    <div class = "contentCard">
        ...
        <p>
            {!! Form::open(['route' => 'approvePost', 'role' => 'form', 'class' => 'formBlock']) !!}
            <input type="hidden" name="beacon_tag" value={{ $post->beacon_tag }}>
            <input type="hidden" name="post_id" value={{ $post->id }}>
            {!! Form::submit('Approve', ['class' => 'navButton', 'id' => 'submit']) !!}
            {!! Form::close() !!}

            {!! Form::open(['route' => 'denyPost', 'role' => 'form', 'class' => 'formBlock']) !!}
            <input type="hidden" name="beacon_tag" value={{ $post->beacon_tag }}>
            <input type="hidden" name="post_id" value={{ $post->id }}>
            {!! Form::submit('Deny', ['class' => 'redButton', 'id' => 'submit']) !!}
            {!! Form::close() !!}
        </p>
    </div>
@endforeach
