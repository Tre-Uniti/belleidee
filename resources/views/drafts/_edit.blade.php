    ...
    <div class = "indexContent" id = "hiddenIndexContent">
        <div class = "formData">
            <div class = "formCreation">
                ...
                <div>
                    <select name = 'belief' class = "tagSelector" required >
                        ...
                        <option value="Jainism" @if (old('belief') == 'Jainism') selected="selected" @elseif($draft->belief == 'Jainism' & (old('belief') == '')) selected="selected" @endif>Jainism</option>
            ...
            <div class = "formCreation">
                ...
                <div>
                    {!! Form::select('beacon_tag', $beacons, $draft->beacon_tag, ['class' => 'tagSelector']) !!}
                </div>
            </div>
            <div class = "formCreation">
