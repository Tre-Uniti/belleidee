...
@section('centerText')
    ...
    <div class = "formDataContainer">
        <div class = "formData">
            ...
            <div class = "formInput">
                {!! Form::select('subscription', [ '0' => 'Starter: Free', '1' => 'Small: (<500) 10$ per month', '2' => 'Medium: (<1000) $25 per month', '3' => 'Large: (>1000) $50 per month'], $beacon->stripe_plan, ['class' => 'selectMenu']) !!}
            </div>
        </div>
        <div class = "formData">
            <div class = "formLabel">
