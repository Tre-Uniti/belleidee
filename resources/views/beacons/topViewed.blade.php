    ...
    @foreach ($beacons as $beaconIndex)
        <div class = "listResource">
            ...
            <div class = "listResourceRight">
                <a href="{{ action('BeaconController@show', [$beaconIndex->beacon_tag])}}"><button type = "button" class = "interactButton" style = "text-align: left;">{{$beaconIndex->tag_views}}</button></a>
            </div>
        </div>
    @endforeach
@stop
