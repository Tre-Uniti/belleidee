...
@section('centerText')
    ...
    <nav class = "infoNav">
        <ul>
            <li>
                <a href = "{{ url('users/extensionTime/Today') }}" @if($time == 'Today')class = "navLink" @else class = "indexLink" @endif>Today</a>
                <a href = "{{ url('users/extensionTime/Month') }}" @if($time == 'Month') class = "navLink" @else class = "indexLink" @endif>Month</a>
                <a href = "{{ url('users/extensionTime/Year') }}" @if($time == 'Year') class = "navLink" @else class = "indexLink" @endif>Year</a>
                <a href = "{{ url('users/extensionTime/All') }}" @if($time == 'All') class = "navLink" @else class = "indexLink" @endif>All Time</a>
            </li>
        </ul>
    </nav>
