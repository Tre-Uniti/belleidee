...
<div id = "container">
    <nav class = "topNav">
        <ul>
            ...
            <li>
                <p onclick="" class = "pNav">Posts<span class="caret"></span></p>
                <div>
                    <ul>
            ...
            <li>
                <p onclick="" class = "pNav">Directory<span class="caret"></span></p>
                <div>
                    <ul>
            ...
            <li>
                <p onclick="" class = "pNav">Settings<span class="caret"></span></p>
                <div>
