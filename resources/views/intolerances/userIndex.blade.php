    ...
    @foreach ($intolerances as $intolerance)
        ...
        <div class = "listResource">
            <div class = "listResourceLeft">
                <a href="{{ action('IntoleranceController@show', [$intolerance->id])}}"><button type = "button" class = "interactButton" style = "text-align: left;">{{ $intolerance->created_at->format('M-d-Y') }}</button></a>
            </div>
