...
Route::get('sponsors/contact/{tag}', 'SponsorController@contact');
Route::get('sponsors/sponsorship/{tag}', 'SponsorController@sponsorship');
Route::get('sponsors/sponsorships/{tag}', 'SponsorController@sponsorships');
Route::get('sponsors/eligible/{tag}', 'SponsorController@eligible');
Route::get('sponsors/eligibleSearch/{tag}', 'SponsorController@eligibleSearch');
...
Route::get('legacyPosts/forYou', 'LegacyPostController@forYou');
